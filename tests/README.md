...
Tests notebooks using Pytest and Nbmake to test code cells with a specified version of `atoti` in `pyproject.toml`. Formatted results are outputted to `./reports`.
