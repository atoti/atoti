...
export const Optimizer: FC<WidgetPluginProps> = (props) => {
    ...
    const [selectedIteration, setSelectedIteration] = useState<any>("base|base");
    ...
    const { data: portfolioData } = useQueryResult({
        ...
        query: {
            mdx: "SELECT NON EMPTY [portfolios].[portfolio].[portfolio].Members ON ROWS FROM [esg_optimization]",
            updateMode: "realTime"
        }
    });
    ...
    const optimizePortfolio = async () => {
        ...
        await axios
            ...
            .catch(err => {
                message.error(`Upload of ${selectedPortfolio}, ${selectedIteration} completed.`);
            })
        ;
    };
